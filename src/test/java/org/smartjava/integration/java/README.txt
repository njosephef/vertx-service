...
To create a Java integration test in Vert.x - that's a test that runs *inside* the Vert.x container,
you should create a class like this which extends `TestVerticle`.
